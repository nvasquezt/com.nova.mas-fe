...
const AddPrevMaintenance = () => {
    ...
    const invoice = 'https://s3.amazonaws.com/thumbnails.venngage.com/template/a2ad94ee-ef0d-4701-8d8d-ae237898ed19.png'
    const date = new Date();
  ...
  return (
    <div className="addPrevMaintenance">
        <div className="addPrevMaintenance__title">
            <h1>🧰  AddPrevMaintenance to Ambulance A-0{id < 10 ? `0${id}` : `${id}`}</h1>
        </div>
        <form action="submit" onSubmit={handleSubmit}>
            <div className="addPrevMaintenance__form">
                <div className="addPrevMaintenance__data">
                    <label htmlFor="description"></label>
                    <textarea name="description" id="description" cols="100" rows="10" placeholder="Description" onChange={handleChange}></textarea>
                </div>
            </div>
